...
Documento creado bajo licencia Creative Commons Zero v1.0 Universal. Versión 2021-0.1. Consultas o sugerencias: agustincordoba28@gmail.com 
...
Como proposición al alumno, la cátedra recomienda tratar de implementar las tres variantes vistas en lenguaje C o similar, por ejemplo, Python. Para ello se deben crear pequeñas rutinas que implementen tanto el emisor como el receptor y una rutina principal que coordine cada protocolo. 
...
Una vez más, la cátedra propone al alumno, tratar de implementar estos protocolos en lengujae C o Python. 
...
Con esta información, ya es posible iniciar el trabajo práctico de Capa de Enlace de Datos disponible en el campus. El mismo debe estar correctamente justificado con los contenidos desarrollados en este informe y en el posterior, que se entregará en breve sobre la Subcapa de Acceso al Medio. 
